...
public class AboutMethodPreference {
	...
	public void methodPreferenceInteger() {
		assertEquals(new A().doStuff(Integer.valueOf(1)), new A().doStuff(new Integer(1)));
	}
	
	@Koan
	public void methodPreferenceLong() {
		long l = 1;
		assertEquals(new A().doStuff(l), new A().doStuff(Long.class));
        //Could not fiure this one out for the life of me
	}
